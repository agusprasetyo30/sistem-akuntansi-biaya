...
class PJPenjualanImport implements ToModel, WithHeadingRow, SkipsOnError, WithValidation, SkipsOnFailure, WithMultipleSheets, WithBatchInserts, WithChunkReading, ToCollection, ShouldQueue
{
    ...
    public function model(array $row)
    {
        ...
        for ($i = 1; $i < $lengthPeriode; $i++) {
            ...
            $list = [
                ...
                'pj_penjualan_value' => (float) $arr[$i],
                'created_by' => auth()->user()->id,
                'created_at' => Carbon::now(),
            ];

            PJ_Penjualan::insert($list);
        }
    }
