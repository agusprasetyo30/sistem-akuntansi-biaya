...
class MaterialDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        ...
        if ($this->filter_company != 'all' && auth()->user()->mapping_akses('material')->company_code == 'all') {
            $query = $query->where('material.company_code', $this->filter_company);
        } else if ($this->filter_company != 'all' && auth()->user()->mapping_akses('material')->company_code != 'all') {
            $query = $query->where('material.company_code', auth()->user()->mapping_akses('material')->company_code);
        }
