let table = function () {
	...
	ewpDatatables({
		...
		column : [
			...
			{col : 'kategori_material_name', mid : false, mod : false},
			{col : 'kategori_material_desc', mid : false, mod : false},
...
let store = function (url, edit = false, modal = '#modal') {
    ...
    formData.append('kategori_material_name', $('[name="kategori_material_name"]').val())
    formData.append('kategori_material_desc', $('[name="kategori_material_desc"]').val())
