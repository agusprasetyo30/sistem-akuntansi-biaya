let table = function () {
	...
	ewpDatatables({
		...
		column : [
			...
			{col : 'produk_name', mid : false, mod : false},
			{col : 'produk_desc', mid : false, mod : false},
			{col : 'kategori_produk_id', mid : false, mod : false},
...
let store = function (url, edit = false, modal = '#modal') {
    ...
    formData.append('kategori_produk_id', $('[name="kategori_produk_id"]').val())
    formData.append('produk_name', $('[name="produk_name"]').val())
    formData.append('produk_desc', $('[name="produk_desc"]').val())
