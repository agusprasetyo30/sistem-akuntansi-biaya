    ...
    !function (o) {
        ...
        o(window).on("load", (function (e) {
            ...
            o(".add").on("click", (function () {
                var e = o(this).closest("div").find(".qty"), t = parseInt(e.val());
                isNaN(t) || e.val(t + 1)
        ...
        })), o(".chart-circle-transparent").length && o(".chart-circle-transparent").each((function () {
            var e = o(this);
            e.circleProgress({
                fill: {color: e.attr("data-color")},
                size: e.height(),
        ...
        o(document).on("click", '[data-bs-toggle="card-close"]', (function (e) {
        ...
        })), o(".sparkline_bar").sparkline([2, 4, 3, 4, 5, 4, 5, 4, 3, 4], {
            height: 20,
            type: "bar",
            colorMap: {7: "#a1a1a1"},
            barColor: "#ff5b51"
        }), o(".sparkline_bar1").sparkline([3, 4, 3, 4, 5, 4, 5, 6, 4, 6], {
            height: 20,
            type: "bar",
            colorMap: {7: "#c34444"},
            barColor: "#44c386"
        }), o(".sparkline_bar2").sparkline([3, 4, 3, 4, 5, 4, 5, 6, 4, 6], {
            height: 20,
            type: "bar",
            colorMap: {7: "#a1a1a1"},
            barColor: "#fa057a"
            ...
            if (this.checked) {
                var e;
                o("body").addClass("rtl"), o("body").removeClass("ltr"), o("html[lang=en]").attr("dir", "rtl"), localStorage.setItem("rtl", "True"), o("head link#style").attr("href", o(this)), null === (e = document.getElementById("style")) || void 0 === e || e.setAttribute("href", "http://127.0.0.1:8000/assets/plugins/bootstrap/css/bootstrap.rtl.min.css");
                ...
                var a;
                o("body").removeClass("rtl"), o("body").addClass("ltr"), localStorage.setItem("rtl", "false"), o("head link#style").attr("href", o(this)), null === (a = document.getElementById("style")) || void 0 === a || a.setAttribute("href", "http://127.0.0.1:8000/assets/plugins/bootstrap/css/bootstrap.min.css")
            }
        })), o("#myonoffswitch54").click((function () {
            if (this.checked) {
                var e;
                o("body").addClass("ltr"), o("body").removeClass("rtl"), o("html[lang=en]").attr("dir", "ltr"), localStorage.setItem("ltr", "True"), o("head link#style").attr("href", o(this)), null === (e = document.getElementById("style")) || void 0 === e || e.setAttribute("href", "http://127.0.0.1:8000/assets/plugins/bootstrap/css/bootstrap.min.css");
                var t = o(".owl-carousel");
                o.each(t, (function (e, t) {
                    var a = o(t).data("owl.carousel");
                ...
                var a;
                o("body").removeClass("ltr"), o("body").addClass("rtl"), localStorage.setItem("ltr", "false"), o("head link#style").attr("href", o(this)), null === (a = document.getElementById("style")) || void 0 === a || a.setAttribute("href", "http://127.0.0.1:8000/assets/plugins/bootstrap/css/bootstrap.rtl.min.css")
            }
        }))
    }(jQuery)
})();
