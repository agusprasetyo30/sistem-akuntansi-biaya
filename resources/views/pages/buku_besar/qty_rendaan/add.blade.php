                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control form-control-sm" placeholder="Deskripsi" name="qty_rendaan_desc"
                                    id="qty_rendaan_desc" autocomplete="off">
                            </div>
                            <div class="form-group">
                                <label>Value </label>
                                <input type="text" class="form-control form-control-sm" placeholder="Value" name="qty_rendaan_value"
                                    id="qty_rendaan_value" autocomplete="off">
                            </div>
                        </div>
                    </div>
                </div>
