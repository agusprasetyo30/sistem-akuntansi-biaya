@if (mapping_akses('qty_rendaan','read'))
...
@if (mapping_akses('qty_rendaan','update'))
...
@if (mapping_akses('qty_rendaan','delete'))
                    ...
                    <div class="row">
                        <div class="col-md-12" style="text-align: start;">
                            ...
                            <div class="form-group">
                                <label>Value </label>
                                <input disabled type="text" class="form-control form-control-sm"
                                    placeholder="0" value="{{$model->qty_rendaan_value}}" name="detail_qty_rendaan_value"
        ...
        <div class="modal-content">
                    ...
                    <div class="row">
                        <div class="col-md-12" style="text-align: start;">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="number" min="0.01" step="0.01" value="{{$model->qty_rendaan_value}}" placeholder="0" required name="edit_qty_rendaan_value{{$model->id}}" id="edit_qty_rendaan_value{{$model->id}}" autocomplete="off">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="modal-footer">
                <div class="btn-list btn-animation">
                    <button type="button" id="submit_edit{{$model->id}}" onclick="update_qty_rendaan({{$model->id}})" class="btn btn-primary">Simpan</button>
