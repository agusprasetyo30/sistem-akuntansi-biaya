                    ...
                    <div class="row">
                        <div class="col-md-12" style="text-align: start;">
                            ...
                            <div class="form-group">
                                ...
                                <input disabled type="text" class="form-control form-control-sm"
                                    placeholder="Deskripsi" value="{{$model->price_rendaan_desc}}" name="detail_price_rendaan_desc"
                                    id="detail_price_rendaan_desc" autocomplete="off">
                            </div>
                            <div class="form-group">
                                <label>Value </label>
                                <input disabled type="text" class="form-control form-control-sm"
...
<div class="modal fade" id="{{__('modal_edit'.$model->id)}}" role="dialog" aria-labelledby="modal_detail"
    ...
    <div class="modal-dialog modal-lg " role="document">
        <div class="modal-content">
                        ...
                        <div class="col-md-12" style="text-align: start;">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control form-control-sm" placeholder="Deskripsi"
                                    value="{{$model->price_rendaan_desc}}" name="edit_price_rendaan_desc"
                                    id="edit_price_rendaan_desc{{$model->id}}" autocomplete="off">
                            </div>
                            <div class="form-group">
                                <label>Value </label>
                                <input type="text" class="form-control form-control-sm" placeholder="Value"
                                    value="{{$model->price_rendaan_value}}" name="edit_price_rendaan_value"
                                    id="edit_price_rendaan_value{{$model->id}}" autocomplete="off">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="modal-footer">
                <button type="button" id="submit_edit" onclick="update_price_rendaan({{$model->id}})"
