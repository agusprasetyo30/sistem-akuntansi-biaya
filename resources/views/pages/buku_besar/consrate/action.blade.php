@if (mapping_akses('cons_rate','read'))
...
@if (mapping_akses('cons_rate','update'))
...
@if (mapping_akses('cons_rate','delete'))
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <div class="btn-list btn-animation">
                    <button type="button" id="submit_edit{{$model->id}}" onclick="update_consrate({{$model->id}})" class="btn btn-primary">Simpan</button>
