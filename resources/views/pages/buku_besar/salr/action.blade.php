...
@if (mapping_akses('salrs','delete'))
    <a class="btn bg-danger-transparent" onclick="delete_salr({{$model->id}})" title="hapus" data-toggle="tooltip"><i class="fe fe fe-trash"></i></a>
@endif
