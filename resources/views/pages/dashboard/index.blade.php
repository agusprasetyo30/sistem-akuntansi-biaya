                ...
                <div class="row">
                    <div class="col-lg-6 col-md-12 col-sm-6 col-6">
                        <div class="">
                            ...
                            <span class=""><i class="fe fe-arrow-up-circle"></i> 76% <span class="ms-1 fs-11">Growth
                                    This Month</span>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-12 col-sm-6 col-6">
                        <div class="">
                            ...
                            <span class=""><i class="fe fe-arrow-down-circle"></i> 15% <span class="ms-1 fs-11">Loss
                                    This Month</span>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-12 col-sm-6 col-6 my-auto mx-auto">
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-12 col-sm-6 col-6">
                        <div class="">
                            ...
                            <span class=""><i class="fe fe-arrow-up-circle"></i> 62% <span class="ms-1 fs-11">From Last
                                    Month</span>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-12 col-sm-6 col-6 my-auto mx-auto">
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-12 col-sm-6 col-6">
                        <div class="text-justify">
                            ...
                            <span class=""><i class="fe fe-arrow-up-circle"></i> 53% <span class="ms-1 fs-11">From Last
                                    Month</span>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-12 col-sm-6 col-6 my-auto mx-auto">
                ...
                <ul class="recent-activity">
                    ...
                    <li class="mb-5">
                        <div>
                            ...
                            <div class="activity-timeline-content">
                                <span class="font-weight-normal1 fs-13">Customer Visits,</span><span
                    ...
                    <li class="mb-5 border-bottom-0">
                        <div>
                            ...
                            <div class="activity-timeline-content">
                                <span class="font-weight-normal1 fs-13">Sale Consistency,</span><span
                                    class="text-muted fs-12 float-end">3 days ago</span>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><img class="avatat avatar-md brround me-2"
                                        src="{{asset('assets/images/orders/7.jpg')}}" alt="img">Books</td>
                            ...
                            <tr>
                                ...
                                <td><img class="avatat avatar-md brround me-2"
                                        src="{{asset('assets/images/orders/5.jpg')}}" alt="img">Sports</td>
                                <td class="fs-13 text-secondary"><span
                                        class="dot-label bg-secondary me-2 w-2 h-2"></span>Shoes</td>
                            ...
                            <tr>
                                ...
                                <td><img class="avatat avatar-md brround me-2"
                                        src="{{asset('assets/images/orders/6.jpg')}}" alt="img">Accesories</td>
                            ...
                            <tr>
                                ...
                                <td><img class="avatat avatar-md brround me-2"
                                        src="{{asset('assets/images/orders/4.jpg')}}" alt="img">Watches</td>
                                <td class="fs-13 text-success"><span
                                        class="dot-label bg-success me-2 w-2 h-2"></span>Smart Watch</td>
                            ...
                            <tr>
                                ...
                                <td><img class="avatat avatar-md brround me-2"
                                        src="{{asset('assets/images/orders/10.jpg')}}" alt="img">speakers</td>
                                <td class="fs-13 text-info"><span class="dot-label bg-info me-2 w-2 h-2"></span>Head set
                                </td>
                                <td><span class="font-weight-normal1">$6427</span></td>
                                <td class="text-muted">Today</td>
                                <td><span class="badge fs-11 bg-info-transparent text-info ms-2 mb-0">Top Pick</span>
                                </td>
                            </tr>
                        </tbody>
                    </table>
    ...
    <div class="col-md-12 col-sm-12 col-lg-6 col-xl-3">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="mb-3">
                    <div class="d-flex">
                        <div class="Recent-transactions-img brround bg-teal text-white font-weight-normal1 text-center">
                            KW</div>
                        <div class="">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div>
                    ...
                    <div class="progress progress-sm">
                        <div class="progress-bar bg-pink progress-bar-striped progress-bar-animated" style="width: 70%">
                        </div>
                    </div>
                </div>
            </div>
