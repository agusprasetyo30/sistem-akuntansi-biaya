    ...
    <div class="modal-dialog modal-lg " role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="largemodal1">Import Group Account Variable Cost</h5>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="col-lg mb-3">
                                    <b>Ketentuan :</b>
                                    <ol>
                                        <li>Format harus sesuai template  ( <a href="{{ route('export_group_account') }}">Download Template</a> )</li>
