@if (mapping_akses('group_account','read'))
...
@if (mapping_akses('group_account','update'))
...
@if (mapping_akses('group_account','delete'))
    ...
    <div class="modal-dialog modal-lg " role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="largemodal1">Detail Group Account Variable Cost</h5>
...
<div class="modal fade" id="{{__('modal_edit'.$model->group_account_code)}}" data-bs-backdrop="static" data-bs-keyboard="false" role="dialog" aria-labelledby="modal_detail"
    ...
    <div class="modal-dialog modal-lg " role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="largemodal1">Edit Group Account Variable Cost</h5>
                {{-- <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">×</span>
                </button> --}}
            </div>
