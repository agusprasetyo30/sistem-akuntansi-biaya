@if (mapping_akses('kategori_balans','read'))
...
@if (mapping_akses('kategori_balans','update'))
...
@if (mapping_akses('kategori_balans','delete'))
                    ...
                    <div class="row">
                        <div class="col-md-12" style="text-align: start;">
                            <div class="form-group">
                                ...
                                <input disabled type="text" class="form-control" value="{{$model->kategori_balans}}" id="detail_kategori_balans{{$model->id}}" placeholder="Bulan-Tahun" autocomplete="off" required>
                            </div>

                            <div class="form-group">
                                <label class="form-label">Deskripsi  <span class="text-red">*</span></label>
                                <input disabled class="form-control" type="text" name="deskripsi" id="detail_deskripsi{{$model->id}}" autocomplete="off" value="{{$model->kategori_balans_desc}}" data-type="currency" placeholder="1.000.000.00">
                            </div>
                        </div>
                    </div>
                </div>
