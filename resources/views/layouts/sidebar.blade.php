...
<aside class="app-sidebar">
	...
	<ul class="side-menu app-sidebar3">
		...
		@if (auth()->user()->mapping_akses('company') || auth()->user()->mapping_akses('kategori_material') || auth()->user()->mapping_akses('kategori_produk') || auth()->user()->mapping_akses('kategori_balans') || auth()->user()->mapping_akses('map_kategori_balans') || auth()->user()->mapping_akses('regions') || auth()->user()->mapping_akses('group_account') || auth()->user()->mapping_akses('gl_account') || auth()->user()->mapping_akses('group_account_fc') || auth()->user()->mapping_akses('gl_account_fc') || auth()->user()->mapping_akses('cost_center') || auth()->user()->mapping_akses('material') || auth()->user()->mapping_akses('plant') || auth()->user()->mapping_akses('glos_cc') || auth()->user()->mapping_akses('tarif') || auth()->user()->mapping_akses('asumsi_umum') || auth()->user()->mapping_akses('kurs'))
		<li class="slide">
			<a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0);">
		...
		<li class="slide">
			...
			<ul class="slide-menu">
                ...
                @if (auth()->user()->mapping_akses('pj_pemakaian') || auth()->user()->mapping_akses('pj_penjualan'))
				<li class="sub-slide">
