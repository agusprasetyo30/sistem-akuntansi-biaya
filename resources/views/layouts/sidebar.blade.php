...
<aside class="app-sidebar">
	...
	<ul class="side-menu app-sidebar3">
		...
		@if (count(array_intersect([1,2,5], auth()->user()->mapping_side_bar_akses())) > 0)
		<li class="slide">
			...
			<ul class="slide-menu">
                ...
                {{-- <li><a href="{{route('user_role')}}" class="slide-item"> Management User Role</a></li> --}}
                <li><a href="{{route('user_akses')}}" class="slide-item"> Management User Akses</a></li>
			</ul>
		</li>
		@endif
