...
<aside class="app-sidebar">
	...
	<ul class="side-menu app-sidebar3">
		...
		<li class="slide">
			...
			<ul class="slide-menu">
{{--                <li><a href="{{route('kuantiti_ren_daan')}}" class="slide-item"> Asumsi Umum</a></li>--}}
{{--                <li><a href="{{route('cost_center')}}" class="slide-item"> Cost Center</a></li>--}}
				...
				<li><a href="{{route('dasar_balans')}}" class="slide-item"> Balans</a></li>
			</ul>
		</li>
        <li class="slide">
            <a class="side-menu__item" href="{{url('dasar_balans')}}">
                ...
                <span class="side-menu__label">Balans</span></a>
        </li>
		<li class="slide">
